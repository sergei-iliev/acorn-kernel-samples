...
#define TWI0_BAUD  (((((CLK_PER /I2C_SCL_FREQ))-10-(CLK_PER * 0.3)/1000000))/2) ;100kH clocking
/**************INIT TWI******************
*@USAGE:temp
*/
twi_init:			
	...
	sts TWI0_MSTATUS,temp

	ldi temp,TWI_ENABLE_bm
	sts TWI0_MCTRLA,temp
ret
