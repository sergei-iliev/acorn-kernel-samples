...
;****add URI from eeprom  
  ldi ZL,low(EEPROM_CONFIG_ADDR+99)
  ldi ZH,high(EEPROM_CONFIG_ADDR+99)

	    
  ldi axh,50 ; size of URI string
  rcall append_eeprom_to_web_buffer
