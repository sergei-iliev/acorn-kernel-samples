...
;send size in the form AT+CIPSEND=xxx	
  ...
  rcall load_request_buffer
    ...
    ;convert to str
  ldi argument,EEPROM_MAX_BUFFER_SIZE+2    ; send 150 bytes + 2 \r\n 
  rcall byte_to_str
...
cf_send_2:
  ...
  ;send EEPROM info to request buffer -150 bytes
  ...
  ADDI16 YL,YH,EEPROM_MAX_BUFFER_SIZE
  ...
  ldi axl,EEPROM_MAX_BUFFER_SIZE+2    ; send 100 bytes + 2 \r\n 
