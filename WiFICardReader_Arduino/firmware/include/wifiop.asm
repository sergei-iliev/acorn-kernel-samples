...
;Interrupt context, used registered pushed on the stack
...
lrd_2:	
ret
;********************Add byte to request buffer*************
;@INPUT:argument
;@USAGE:temp,X
;@WARNING: Up to 1 byte size bytes - 256
;*********************************************************
/*
add_byte_request_buffer:
  ldi XL,low(RequestBuffer)
  ldi XH,high(RequestBuffer) 
...
DEBUG_REQUEST: .db "SEND OK",0x0D,"+IPD,10, acorn kernel rocks",0
DEBUG_ANSWER:		.db "1:",0