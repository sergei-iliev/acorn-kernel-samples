...
#define RESPONSE_NONE 0x00  ; no RS232 communication at all
...
txmain: 
	...
	;set default rs232 state
    ldi temp,RESPONSE_NONE
    sts RS232Status,temp
...
rsint_rx_exit:
  ;if we are here -> RS232 is alive
  ldi temp,RESPONSE_FAILURE | RESPONSE_OK
  sts RS232Status,temp
